            ...
            <div className="flex justify-end mb-6">
                <div className="flex items-center space-x-3">
                    ...
                    <button
                        ...
                        className={`w-16 h-8 flex items-center rounded-full p-1 transition duration-300 ${isGridThree ? 'bg-green-600' : 'bg-blue-600'
                            }`}
                    >
                        <div
                ...
                {food.map(({ _id, foodName, imageUrl, foodQuantity, location, description, availability }) => (
                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <Link
                                to={`/food-details/${_id}`}
                                className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 rounded-lg"
                            >
                                View Details
                                <svg
